...
class TestColllectionService(unittest.TestCase):
    def setUp(self):
        self.url = "http://127.0.0.1:5004/collections"

    def test_collection_records(self):
        """ Test /collections/<username> for all known collections"""
        for date, expected in GOOD_RESPONSES.iteritems():
            ...
            self.assertEqual(len(actual_reply), len(expected),
                             "Got {} collection but expected {}".format(
